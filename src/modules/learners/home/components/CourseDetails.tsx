              ...
              <div className="main-part">
                ...
                <div className="authors">
                  ...
                  <div className="author-content">
                    ...
                    <p>
                      I'm an Afro-Latina digital artist originally from Long
                      Island, NY. I love to paint design and photo manpulate in
                      Adobe Photoshop while helping others learn too. Follow me
                      on Instagram or tweet me
                    </p>
                  ...
                  <ul className="comment-list">
                    <li className="comment">
                      ...
                      <div className="com-content">
                        ...
                        <p>
                          The inner sanctuary, I throw myself down among the
                          tall grass bye the trckli stream and, as I lie close
                          to the earth
                        </p>
                      </div>
                      <ul className="comment-list">
                        <li className="comment">
                          ...
                          <div className="com-content">
                            ...
                            <p>
                              ...
                              entire soul, like these sweet mornings spring
                ...
                <div className="course-side-detail">
                  <div className="csd-title">
                    ...
                    <div className="csdt-right">
                      <p className="mb-0">
                        <i className="icofont-clock-time"></i>Limited time offer
                      </p>
                    </div>
                  </div>
                  <div className="csd-content">
                    <div className="csdc-lists">
                      <ul className="lab-ul">
                        ...
                        <li>
                          <div className="csdc-left">
                            <i className="icofont-video-alt"></i>Lessions
                          </div>
                          <div className="csdc-right">18x</div>
                        </li>
                        <li>
                          <div className="csdc-left">
                            <i className="icofont-abacus-alt"></i>Quizzes
                          </div>
                          <div className="csdc-right">0</div>
                        </li>
                        <li>
                          <div className="csdc-left">
                            <i className="icofont-hour-glass"></i>Pass
                            parcentages
                          </div>
                        ...
                        <li>
                          <div className="csdc-left">
                            <i className="icofont-certificate"></i>Certificate
                          </div>
                          <div className="csdc-right">Yes</div>
                        </li>
                        <li>
                          <div className="csdc-left">
                            <i className="icofont-globe"></i>Language
                          </div>
